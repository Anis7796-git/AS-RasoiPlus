        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="chefBookCustomer.html">
  <i class="bi bi-bookmark-star"></i> Book a Chef
</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="customerOrderHistory.html"><i class="bi bi-clock-history"></i> Order History</a>
                    </li>
                </ul>
    ...
    <div class="dashboard-container container">
        ...
        <div class="mb-5">
            ...
            <div class="row">
                <!-- Kitchen Card 1 -->
                <div class="col-md-6 col-lg-4 col-xl-3 fade-in" style="animation-delay: 0.1s;">
                    <div class="kitchen-card">
                        <img src="https://images.unsplash.com/photo-1559847844-5315695dadae?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Kitchen" class="kitchen-img">
                        <div class="kitchen-card-body">
                            <h3 class="kitchen-title">Spice Heaven</h3>
                            <p class="kitchen-location"><i class="bi bi-geo-alt"></i> Koramangala, 2.5 km away</p>
                            ...
                            <button class="view-menu-btn" data-bs-toggle="modal" data-bs-target="#menuModal">
                ...
                <!-- Kitchen Card 2 -->
                <div class="col-md-6 col-lg-4 col-xl-3 fade-in" style="animation-delay: 0.2s;">
                    <div class="kitchen-card">
                        <img src="https://images.unsplash.com/photo-1601050690597-df0568f70950?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Kitchen" class="kitchen-img">
                        <div class="kitchen-card-body">
                            <h3 class="kitchen-title">Biryani Blues</h3>
                            <p class="kitchen-location"><i class="bi bi-geo-alt"></i> Indiranagar, 3.1 km away</p>
                            <div class="kitchen-rating">
                                <div class="rating-stars">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                ...
                <!-- Kitchen Card 3 -->
                <div class="col-md-6 col-lg-4 col-xl-3 fade-in" style="animation-delay: 0.3s;">
                    <div class="kitchen-card">
                        <img src="https://images.unsplash.com/photo-1513104890138-7c749659a591?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Kitchen" class="kitchen-img">
                        <div class="kitchen-card-body">
                            <h3 class="kitchen-title">Pizza Paradise</h3>
                            <p class="kitchen-location"><i class="bi bi-geo-alt"></i> Whitefield, 5.7 km away</p>
                            <div class="kitchen-rating">
                                <div class="rating-stars">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                ...
                <!-- Kitchen Card 4 -->
                <div class="col-md-6 col-lg-4 col-xl-3 fade-in" style="animation-delay: 0.4s;">
                    <div class="kitchen-card">
                        <img src="https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Kitchen" class="kitchen-img">
                        <div class="kitchen-card-body">
                            <h3 class="kitchen-title">Dosa Delight</h3>
                            <p class="kitchen-location"><i class="bi bi-geo-alt"></i> Jayanagar, 1.8 km away</p>
                            <div class="kitchen-rating">
                                <div class="rating-stars">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
        ...
        <div class="mb-5">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 fade-in" style="animation-delay: 0.1s;">
                    <div class="kitchen-card">
                        <img src="https://images.unsplash.com/photo-1544025162-d76694265947?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Kitchen" class="kitchen-img">
                        <div class="kitchen-card-body">
                            <h3 class="kitchen-title">Burger Barn</h3>
                            <p class="kitchen-location"><i class="bi bi-geo-alt"></i> HSR Layout, 4.2 km away</p>
                            <div class="kitchen-rating">
                                <div class="rating-stars">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 fade-in" style="animation-delay: 0.2s;">
                    <div class="kitchen-card">
                        <img src="https://images.unsplash.com/photo-1565557623262-b51c2513a641?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Kitchen" class="kitchen-img">
                        <div class="kitchen-card-body">
                            <h3 class="kitchen-title">Chinese Wok</h3>
                            <p class="kitchen-location"><i class="bi bi-geo-alt"></i> Bellandur, 6.5 km away</p>
                            <div class="kitchen-rating">
                                <div class="rating-stars">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 fade-in" style="animation-delay: 0.3s;">
                    <div class="kitchen-card">
                        ...
                        <div class="kitchen-card-body">
                            ...
                            <p class="kitchen-location"><i class="bi bi-geo-alt"></i> MG Road, 3.8 km away</p>
                            <div class="kitchen-rating">
                                <div class="rating-stars">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 fade-in" style="animation-delay: 0.4s;">
                    <div class="kitchen-card">
                        <img src="https://images.unsplash.com/photo-1563805042-7684c019e1cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Kitchen" class="kitchen-img">
                        <div class="kitchen-card-body">
                            <h3 class="kitchen-title">Sweet Tooth</h3>
                            <p class="kitchen-location"><i class="bi bi-geo-alt"></i> Malleshwaram, 5.2 km away</p>
                            <div class="kitchen-rating">
                                <div class="rating-stars">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content menu-modal">
                <div class="modal-header">
                    <h5 class="modal-title" id="menuModalLabel">Spice Heaven - Full Menu</h5>
                    ...
                    <div class="menu-category">
                        ...
                        <div class="menu-item">
                            <div>
                                ...
                                <div class="menu-item-desc">Fragrant basmati rice cooked with tender chicken pieces and aromatic spices</div>
                            </div>
                            <div>
                                <div class="menu-item-price">₹250</div>
                                <button class="order-item-btn mt-2" data-item="Chicken Biryani" data-price="250">
                        ...
                        <div class="menu-item">
                            <div>
                                ...
                                <div class="menu-item-desc">Slow-cooked mutton with long grain rice and secret spice blend</div>
                            </div>
                            <div>
                                <div class="menu-item-price">₹320</div>
                                <button class="order-item-btn mt-2" data-item="Mutton Biryani" data-price="320">
                                    <i class="bi bi-cart-plus"></i> Order
                                </button>
                            </div>
                        </div>
                        <div class="menu-item">
                            <div>
                                ...
                                <div class="menu-item-desc">Colorful vegetables cooked with fragrant rice and mild spices</div>
                            </div>
                            <div>
                                <div class="menu-item-price">₹180</div>
                                <button class="order-item-btn mt-2" data-item="Veg Biryani" data-price="180">
                                    <i class="bi bi-cart-plus"></i> Order
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="menu-category">
                        ...
                        <div class="menu-item">
                            <div>
                                ...
                                <div class="menu-item-desc">Stir-fried rice with chicken, eggs and vegetables</div>
                            </div>
                            <div>
                                <div class="menu-item-price">₹200</div>
                                <button class="order-item-btn mt-2" data-item="Chicken Fried Rice" data-price="200">
                                    <i class="bi bi-cart-plus"></i> Order
                                </button>
                            </div>
                        </div>
                        <div class="menu-item">
                            <div>
                                ...
                                <div class="menu-item-desc">Classic fried rice with scrambled eggs and veggies</div>
                            </div>
                            <div>
                                <div class="menu-item-price">₹160</div>
                                <button class="order-item-btn mt-2" data-item="Egg Fried Rice" data-price="160">
                                    <i class="bi bi-cart-plus"></i> Order
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="menu-category">
                        ...
                        <div class="menu-item">
                            <div>
                                ...
                                <div class="menu-item-desc">Tandoori chicken in rich tomato and butter gravy</div>
                            </div>
                            <div>
                                <div class="menu-item-price">₹280</div>
                                <button class="order-item-btn mt-2" data-item="Butter Chicken" data-price="280">
                                    <i class="bi bi-cart-plus"></i> Order
                                </button>
                            </div>
                        </div>
                        <div class="menu-item">
                            <div>
                                ...
                                <div class="menu-item-desc">Creamy black lentils slow-cooked overnight</div>
                            </div>
                            <div>
                                <div class="menu-item-price">₹180</div>
                                <button class="order-item-btn mt-2" data-item="Dal Makhani" data-price="180">
                                    <i class="bi bi-cart-plus"></i> Order
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="menu-category">
                        ...
                        <div class="menu-item">
                            <div>
                                ...
                                <div class="menu-item-desc">2 pieces of warm milk dumplings in sugar syrup</div>
                            </div>
                            <div>
                                <div class="menu-item-price">₹80</div>
                                <button class="order-item-btn mt-2" data-item="Gulab Jamun" data-price="80">
                                    <i class="bi bi-cart-plus"></i> Order
                                </button>
                            </div>
                        </div>
                        <div class="menu-item">
                            <div>
                                ...
                                <div class="menu-item-desc">Traditional rice pudding with nuts</div>
                            </div>
                            <div>
                                <div class="menu-item-price">₹90</div>
                                <button class="order-item-btn mt-2" data-item="Kheer" data-price="90">
                                    <i class="bi bi-cart-plus"></i> Order
                                </button>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary">Book This Chef</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content quantity-modal">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="location-option selected">
                        <input type="radio" class="location-radio" name="deliveryLocation" id="currentLocation" checked>
                        <label for="currentLocation" class="location-label">
                    ...
                    <div class="location-option">
                        <input type="radio" class="location-radio" name="deliveryLocation" id="otherLocation">
                        <label for="otherLocation" class="location-label">
